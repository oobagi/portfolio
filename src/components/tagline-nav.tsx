...
export function TaglineNav() {
  return (
    <p className="tagline">
      ...
      <span className="tagline-nowrap"><FolderOpen size={18} strokeWidth={2.5} className="tagline-icon" />{" "}<Link href="/projects" className="tagline-link">projects</Link></span> or grab his{" "}
