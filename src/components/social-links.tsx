...
interface SocialLinksProps extends HTMLAttributes<HTMLElement> {
  links: SocialLink[];
}
...
export function SocialLinks({ links, className, ...rest }: SocialLinksProps) {
  return (
    <nav aria-label="Social links" className={className} {...rest}>
          ...
          <li key={link.platform}>
            <a
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-lg
                ...
                hover:bg-[var(--bg-secondary)] hover:text-[var(--brand-primary)]
